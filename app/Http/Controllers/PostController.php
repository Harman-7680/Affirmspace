...
class PostController extends Controller
{
    public function store(Request $request)
    {
        ...
        foreach ($friends as $friend) {
            ...
            $tokens = UserDevice::where('user_id', $friend->id)
                ->pluck('device_token');
            ...
            if ($existing) {
                ...
                if ($post->user_id != $user->id) {
                    ...
                    if (! $alreadyNotified) {
                        ...
                        // Firebase push
                        $tokens = UserDevice::where('user_id', $post->user_id)
                            ->pluck('device_token');
                        ...
                        foreach ($tokens as $token) {
                            try {
                                ...
                                Log::error('Firebase Like Push Error: ' . $e->getMessage());
                            }
                        }
                    }
                }
            ...
            if ($comment->parent_id) {
                ...
                if ($parentComment && $parentComment->user_id != $user->id) {
                    ...
                    if (! $alreadyNotifiedReply) {
                        ...
                        $tokens = UserDevice::where('user_id', $parentComment->user_id)
                            ->pluck('device_token');
                        ...
                        foreach ($tokens as $token) {
                            try {
                                ...
                                Log::error('Firebase Reply Push Error: ' . $e->getMessage());
                            }
                        }
                    }
                }
                ...
                if (! $alreadyNotified) {
                    ...
                    foreach ($tokens as $token) {
                        try {
                            ...
                            Log::error('Firebase Comment Push Error: ' . $e->getMessage());
                        }
                    }
                }
            }
